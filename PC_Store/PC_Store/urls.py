...
urlpatterns = [
    ...
    path('password-reset/', auth_views.PasswordResetView.as_view(template_name='pass/password_reset.html'), name='password_reset'),
    ...
    path('password-reset-confirm/<uidb64>/<token>/',
     auth_views.PasswordResetConfirmView.as_view(template_name='pass/password_reset_confirm.html'), name='password_reset_confirm'),
